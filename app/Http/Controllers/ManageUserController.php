    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($users)
                ...
                ->addColumn('location_access', function ($row) {
                    $location_access = $row->permitted_locations();
                    if($location_access != 'all') {
                        $location_name = [];
                        foreach ($location_access as $key=>$value) {
                            $business_location = BusinessLocation::find($value);
                            $get_location_name = $business_location->name;
