...
Route::middleware(['MeasureResponseTime'])->group(function () {
    ...
    Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
        ...
        Route::get('/products_for_location', 'ProductController@productsForLocation');
        ...
        Route::post('/purchases/upload_purchase_data', 'PurchaseController@uploadPurchaseData');
        ...
        Route::get('/reports/product-sell-report-with-tax', 'ReportController@getProductSellReportWithTax');
        ...
        Route::get('/download-sample-file', 'ImportOpeningStockController@download_sample_file');
