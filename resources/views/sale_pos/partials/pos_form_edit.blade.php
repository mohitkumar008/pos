	...
	<div class="col-md-4">
		<div class="form-group" style="width: 100% !important">
			<div class="input-group">
				...
				value="{{ $transaction->contact?$transaction->contact->id:'' }}" >
				<input type="hidden" id="default_customer_name" 
				value="{{ $transaction->contact?$transaction->contact->name:''}}" >
				<input type="hidden" id="default_customer_balance" 
				value="{{$transaction->contact?$transaction->contact->balance:''}}" >
