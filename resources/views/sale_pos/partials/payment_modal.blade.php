    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 mb-12" id="advance_details">
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool reset_payment_modal" title="Reset Payment Form"><i class="fa fa-redo fa-2x"></i></i></button>
                        </div>
