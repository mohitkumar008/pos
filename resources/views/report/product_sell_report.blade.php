        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#psr_with_tax_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list" aria-hidden="true"></i> @lang('lang_v1.by_tax')</a>
                    </li>
                    <li>
                ...
                <div class="tab-content">
                            ...
                            id="product_sell_report_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('sale.price_inc_discount')</th>
                                        <th>@lang('tax_rate.igst_tax_rate')</th>
                                        <th>@lang('tax_rate.igst_tax_amount')</th>
                                        <th>@lang('tax_rate.cgst_tax_rate')</th>
                                        <th>@lang('tax_rate.cgst_tax_amount')</th>
                                        <th>@lang('tax_rate.sgst_tax_rate')</th>
                                        <th>@lang('tax_rate.sgst_tax_amount')</th>
                                        <th>@lang('sale.tax')</th>
                    ...
                    <div class="tab-pane" id="psr_with_tax_tab">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" 
                            id="product_sell_report_with_tax_table">
                                <thead>
                                    <tr>
                                        <th>@lang('sale.customer_name')</th>
                                        <th>@lang('lang_v1.contact_id')</th>
                                        ...
                                        <th>@lang('tax_rate.sgst_tax_rate')</th>
                                        <th>@lang('tax_rate.sgst_tax_amount')</th>
                                        <th>@lang('tax_rate.cess_tax_rate')</th>
                                        <th>@lang('tax_rate.cess_tax_amount')</th>
                                        <th>@lang('sale.tax')</th>
                                        <th>@lang('sale.total')</th>
                                    </tr>
                                </thead>
                                <tfoot>
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        <td colspan="6"><strong>@lang('sale.total'):</strong></td>
                                        <td id="footer_tax_total_sold"></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td id="footer_tax_total"></td>
                                        <td></td>
                                        <td><span class="display_currency" id="footer_tax_subtotal" data-currency_symbol ="true"></span></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready( function() {
            $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
                ...
                } else if(target == '#psr_with_tax_tab') {
