<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('BusinessLocationController@store'),
            'method' => 'post',
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('custom_field3', ['warehouse' => __('business.warehouse'), 'mart' => __('business.mart')], null,['class' => 'form-control', 'required','placeholder' => $location_custom_field3]) !!}
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
                ...
                <div class="col-sm-12 text-center">
                    <div class="form-group">
                        <div class="checkbox">
                            <br>
                            <label>
                                {!! Form::checkbox('allow_overselling', 1, false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.allow_overselling') }}
                            </label>
