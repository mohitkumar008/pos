...
<section class="content">
    ...
    @endif
    {!! Form::open(['url' => action('PurchaseController@store'), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true , 'enctype' => 'multipart/form-data']) !!}
        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {!! Form::label('purchase_csv', __( 'product.file_to_import' ) . ':') !!}
                            {{-- @show_tooltip(__('lang_v1.tooltip_import_opening_stock')) --}}
                            {!! Form::file('purchase_csv', ['id' => 'purchase_csv']); !!}
                            <button type="button" id="uploadPurchaseData" class="btn btn-success">Upload</button>
                            <img src="{{asset('img/loading.gif')}}" alt="" id="loading-gif" width="30" style="display: none">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <br>
                ...
                <table class="table table-condensed table-bordered table-th-green text-center table-striped" id="purchase_entry_table">
                    <thead>
                        <tr>
                            ...
                            <th class="{{$hide_tax}} width-15">@lang( 'purchase.product_tax' )</th>
