	    	...
	    	{!! Form::open(['url' => action('ProductController@updateProductLocation'), 'method' => 'post', 'id' => 'edit_product_location_form' ]) !!}
			    ...
			    <div class="modal-body">
			        <div class="form-group">
		                {!! Form::label('products_for_location',  __('barcode.products') . ':') !!}
		                {!! Form::select('products_for_location', [], null, ['class' => 'form-control select2', 'id' => 'products_for_location', 'multiple','style' => 'width: 100%;']); !!}
		            </div>
			    	<div class="form-group">
