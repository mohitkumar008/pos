...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="clearfix"></div>
            <div class="col-sm-4 {{auth()->user()->can('product.price.update') == 'admin' ? "" : "hide" }}">
              <div class="form-group">
            ...
            <div class="form-group col-sm-12 {{auth()->user()->can('product.price.update') == 'admin' ? "" : "hide" }}" id="product_form_part"></div>
